# Goal: Dive into advanced Redis features and best practices.
...
- Create a real-time leaderboard using Sorted Sets
- Implement a reliable message queue using Redis Streams
